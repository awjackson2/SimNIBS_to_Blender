...
def main():
    ...
    ap.add_argument('--length-scale', type=float, default=0.01, help='Scale factor for arrow length in linear mode (scene units per V/m)')
    ap.add_argument('--vector-scale', type=float, default=0.1, help='Global mesh scale applied to arrows')
    ap.add_argument('--vector-width', type=float, default=1.0, help='Arrow shaft width')
    ap.add_argument('--vector-length', type=float, default=0.1, help='Base arrow length (used in visual mode)')
    ...
    write_ply_arrows(
        ...
        length_mode=args.length_mode, length_scale=args.length_scale, anchor=args.anchor,
